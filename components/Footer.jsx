...
const Footer = () => {
  return (
    <div className="text-white flex pt-12 bg-black h-[300px]">
      <Wrapper>
        <div className="w-full bg-[#c31f26] text-white px-10 flex">
          <div className="w-1/2 py-4 pr-4 text-justify space-y-4">
          ...
          <div className="w-1/2 py-4 pl-28 text-justify">
            <h1 className="font-bold text-3xl">Follow Us On Social Media</h1>
            <div className="py-5 space-x-6 flex">
              <a href="">
        ...
        <span className="text-black font-semibold text-lg">&copy; {new Date().getFullYear()} TEDxSMIU</span>
        <span className="ml-2 w-4 h-4 text-2xl font-semibold">|</span>
        <span className="ml-2">This independent TEDx event is operated underlicense from TED.</span>
        </div>
        </div>
      </Wrapper>
    </div>
