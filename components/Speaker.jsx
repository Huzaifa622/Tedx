...
const Speaker = () => {
  ...
  return (
    <div className="text-white h-screen space-y-3 max-h-[1080px]">
      <Wrapper>
        <UpperDesign heading={"Speaker"}/>
        {/* slider */}
        <div className="relative p-4 w-full space-y-6 lg:space-y-10">
          {/* slider card */}
          <div className="px-20 ">
            <div className="w-full flex bg-[#c31f26] rounded-md">
              {/* desc */}
              <div className="p-5 flex-[1.5] space-y-1 lg:py-14 ">
              ...
              {/* image */}
              <div
                className="relative aspect-[2.4/1] overflow-hidden bg-center bg-cover w-[35%]"
                style={{
                  clipPath:
